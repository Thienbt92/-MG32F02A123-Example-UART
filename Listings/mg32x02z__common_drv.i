...
#line 32 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z__Common_DRV.c"
...
__weak DRV_Return InitTick(uint32_t TickClock, uint32_t TickPriority)
{
    ...
    __NVIC_SetPriority(SysTick_IRQn, TickPriority);
...
__weak void Delay(volatile uint32_t DelayTime)
{
