...
#line 156 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_I2C_MID.c"
#line 1 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Include\\MG32x02z_CSC_MID.h"
...
#line 157 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_I2C_MID.c"
...
#line 189 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_I2C_MID.c"
...
uint32_t MID_I2C_GetInitTiming(I2C_HandleTypeDef *mI2C, uint32_t SCLClock)  
{
    volatile uint32_t lI2Cx_CK_PRFreq;
    volatile uint32_t lI2C_PSC = 1;
    volatile uint32_t lI2C_DIV = 1;
    volatile uint32_t lI2C_DIV_CNT = 0;
    volatile uint32_t lI2C_HT_LT;
    ...
    if(mI2C->Instance == ((I2C_Struct*) ((uint32_t)0x51000000)))
    {
        lI2Cx_CK_PRFreq = MID_CSC_GetCK_PRFreq(MID_CSC_CK_PR_I2C0);
    }


    if(mI2C->Instance == ((I2C_Struct*) ((uint32_t)0x51010000)))
    {
        lI2Cx_CK_PRFreq = MID_CSC_GetCK_PRFreq(MID_CSC_CK_PR_I2C0);
    }
...
#line 352 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_I2C_MID.c"
    }
...
MID_StatusTypeDef MID_I2C_Init(I2C_HandleTypeDef *mI2C)
{
    ...
    mI2C->Instance->CLK.W = (mI2C->Init.Timing & (((uint32_t)0x00001000) | ((uint32_t)0x00000700) | ((uint32_t)0x00000070) | ((uint32_t)0x0000000C)));
    mI2C->Instance->CR1.W = ((mI2C->Init.Timing >> 16) & (((uint32_t)0x00000F00) | ((uint32_t)0x0000001F)));

     
     
    mI2C->Instance->CR0.W &= ~((uint32_t)0x00000002);
    ...
    mI2C->Instance->CR0.W &= ~((uint32_t)0x00000004);
    ...
    mI2C->Instance->CR0.W |= (mI2C->Init.GeneralCallMode | mI2C->Init.DualAddressMode | ((uint32_t)0x00000002));
    ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40) | ((uint8_t )0x04)));
...
MID_StatusTypeDef MID_I2C_IsDeviceReady(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint32_t Trials, uint32_t Timeout)
{
    ...
    {
        if((((((mI2C)->Instance ->STA . W) & (((uint32_t)0x00000001))) == (((uint32_t)0x00000001))) ? SET : CLR) != CLR)
        {
            if((((((mI2C)->Instance ->STA . W) & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))) ? SET : CLR) != CLR)
            {
                lEventTemp = ((mI2C)->Instance ->STA2 . B[0] & 0xF8);
        ...
        ((mI2C)->Instance ->CR0 . B[0] &= ~((uint8_t )0x40));

         
        ((mI2C)->Instance ->INT . W &= (~(((uint32_t)0x00000008) | ((uint32_t)0x00000004) | ((uint32_t)0x00000002)))); 

         
        ((mI2C)->Instance ->STA . W = ((((uint32_t)0x00200000) | ((uint32_t)0x00400000) | ((uint32_t)0x00800000) | ((uint32_t)0x00080000) | ((uint32_t)0x00100000) | ((uint32_t)0x00000200) | ((uint32_t)0x00000100))));
        ...
        do{
            ...
            if((lEventTemp == 0xF8) || (lEventTemp == 0xA0))
                ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x01) | ((uint8_t )0x10)));
            ...
            if((mI2C->State & MID_I2C_STATE_ERROR) == 0)
            {
...
MID_StatusTypeDef MID_I2C_Slave_Transmit(I2C_HandleTypeDef *mI2C, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        mI2C->Instance->CR0.W |= (((uint32_t)0x00000002) | mI2C->Init.DualAddressMode | mI2C->Init.GeneralCallMode);
        ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40) | ((uint8_t )0x04)));
...
MID_StatusTypeDef MID_I2C_Slave_Receive(I2C_HandleTypeDef *mI2C, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        do{
            ...
            lEventCode = ((mI2C)->Instance ->STA2 . B[0] & 0xF8);
...
MID_StatusTypeDef MID_I2C_Master_Transmit_IT(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        ((mI2C)->Instance ->INT . W |= ((((uint32_t)0x00000001) | ((uint32_t)0x00000002)))); 
...
MID_StatusTypeDef MID_I2C_Master_Transmit_DMA(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
    MID_StatusTypeDef lDmaXferStatus;
    volatile uint8_t lEventTemp;
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        mI2C->ErrorCode = MID_I2C_ERROR_NONE;
        mI2C->State = MID_I2C_STATE_BUSY_TX;
        mI2C->Mode = MID_I2C_MODE_MASTER_TRANSMIT_DMA_STOP;
        ...
        if(mI2C->hdmatx != 0)
        {
            mI2C->hdmatx->XferCpltCallback = I2C_DMACplt;
            mI2C->hdmatx->XferErrorCallback = I2C_DMAError;
            mI2C->hdmatx->XferAbortCallback = 0;
            mI2C->hdmatx->XferHalfCpltCallback = 0;
            lDmaXferStatus = MID_DMA_Start_IT(mI2C->hdmatx, (uint32_t)pData, 0, (uint32_t)Size);
        }
        else
        {
            mI2C->State = MID_I2C_STATE_READY;
            mI2C->Mode = MID_I2C_MODE_NONE;
            mI2C->ErrorCode |= MID_I2C_ERROR_DMA_PARAM;
            do{ (mI2C)->Lock = MID_UnLocked; }while (0);
            return MID_ERROR;
        }

        if(lDmaXferStatus == MID_OK)
        {
...
MID_StatusTypeDef MID_I2C_Master_Transmit_RepeatStart_DMA(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        mI2C->ErrorCode = MID_I2C_ERROR_NONE;
        mI2C->State = MID_I2C_STATE_BUSY_TX;
        mI2C->Mode = MID_I2C_MODE_MASTER_TRANSMIT_DMA_RREPEATSTART;
...
MID_StatusTypeDef MID_I2C_Master_Receive_DMA(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint8_t *pData, uint16_t Size)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        mI2C->ErrorCode = MID_I2C_ERROR_NONE;
        mI2C->State = MID_I2C_STATE_BUSY_RX;
        mI2C->Mode = MID_I2C_MODE_MASTER_RECEIVE_DMA_STOP;
        ...
        if(mI2C->hdmarx != 0)
        {
            mI2C->hdmarx->XferCpltCallback = I2C_DMACplt;
            mI2C->hdmarx->XferErrorCallback = I2C_DMAError;
            mI2C->hdmarx->XferAbortCallback = 0;
            mI2C->hdmarx->XferHalfCpltCallback = 0;
            lDmaXferStatus = MID_DMA_Start_IT(mI2C->hdmarx, (uint32_t)pData, 0, (uint32_t)Size);
        }
        else
        {
            mI2C->State = MID_I2C_STATE_READY;
...
MID_StatusTypeDef MID_I2C_Mem_Write_IT(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        do{
            if(I2C_WaitOnEVENTFlagUntilTimeout(mI2C, ((uint32_t)25U), tickstart) != MID_OK)
            {
...
MID_StatusTypeDef MID_I2C_Mem_Write_DMA(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x08) | ((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40)));
        mI2C->Instance->CR0.W |= ((uint32_t)0x80000000);
        while((mI2C->Instance->STA2.B[1] & ((uint8_t )0x01)) != 0);
...
MID_StatusTypeDef MID_I2C_Mem_Read_DMA(I2C_HandleTypeDef *mI2C, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
    ...
    if((mI2C->State & (MID_I2C_STATE_READY | MID_I2C_STATE_BUSY)) == MID_I2C_STATE_READY)
    {
        ...
        mI2C->hdmarx->XferAbortCallback = 0;
        mI2C->hdmarx->XferHalfCpltCallback = 0;
        lDmaXferStatus = MID_DMA_Start_IT(mI2C->hdmarx, 0, (uint32_t)pData, (uint32_t)Size);
...
void MID_I2C_IRQHandler(I2C_HandleTypeDef *mI2C)
{
    ...
    uint32_t itflags   = ((mI2C->Instance ->STA . W));
    uint32_t itsources = ((mI2C->Instance ->INT . W));
...
static void I2C_ListenP(I2C_HandleTypeDef *mI2C)
{
    if((mI2C->Instance->CR0.B[0] & (((uint8_t )0x02) | ((uint8_t )0x04) | ((uint8_t )0x80))) != 0)
    {
        ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40) | ((uint8_t )0x04)));
        mI2C->State |= MID_I2C_STATE_LISTEN;
    }
    else
        ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40)));
}
...
static MID_StatusTypeDef I2C_BytemodeMasterEventHandle(I2C_HandleTypeDef *mI2C)
{
    ...
    if((mI2C->Instance->STA2.W & ((uint32_t)0x00000100)) == 0)
        return MID_OK;

    lState = ((mI2C)->Instance ->STA2 . B[0] & 0xF8);
    switch(lState){
        case 0x00:  
            mI2C->ErrorCode = MID_I2C_ERROR_BERR;
            mI2C->State |= MID_I2C_STATE_ERROR;

            if((mI2C->Instance->INT.W & ((uint32_t)0x00000002)) != 0)
                MID_I2C_ErrorCallback(mI2C);

            ((mI2C)->Instance ->STA . W = (((uint32_t)0x00800000) | ((uint32_t)0x00000008)));
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
            while(((mI2C)->Instance ->STA2 . B[0] & 0xF8) != 0xF8);
            ((mI2C)->Instance ->INT . W &= (~(((uint32_t)0x00000002))));
            mI2C->State &= (~MID_I2C_STATE_BUSY);
            I2C_ListenP(mI2C);
            break;
        ...
        case 0x08:  
        case 0x10:  
            ((mI2C)->Instance ->CR2 . B[0] = ((uint8_t )0x10));
            ((mI2C)->Instance ->SBUF . B[0] = (((uint8_t)mI2C->DevAddress)));
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
            break;
        ...
        case 0x20:  
            ...
            {
                (((((mI2C)->Instance ->STA . W) & (((uint32_t)0x00200000) | ((uint32_t)0x00000008))) == (((uint32_t)0x00200000) | ((uint32_t)0x00000008))) ? SET : CLR);
                ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40) | ((uint8_t )0x02)));
                ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
                while(((mI2C)->Instance ->STA2 . B[0] & 0xF8) != 0xF8);
      ...
      EventCode0x28:
        case 0x28:  
            if(mI2C->XferCount == mI2C->XferSize)
            {
                ...
                {
                    ((mI2C)->Instance ->INT . W &= (~(((uint32_t)0x00000002))));
                    ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40) | ((uint8_t )0x01)));
                    ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
                    while(((mI2C)->Instance ->STA2 . B[0] & 0xF8) != 0x10);
                }
            ...
            ((mI2C)->Instance ->SBUF . B[0] = (mI2C->pBuffPtr[mI2C->XferCount]));
            mI2C->XferCount ++;
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
            break;
        ...
        case 0x38:  
            ...
            (((((mI2C)->Instance ->STA . W) & (((uint32_t)0x00400000) | ((uint32_t)0x00000008))) == (((uint32_t)0x00400000) | ((uint32_t)0x00000008))) ? SET : CLR);
            ((mI2C)->Instance ->INT . W &= (~(((uint32_t)0x00000002))));
            I2C_ListenP(mI2C);
            mI2C->State &= (~MID_I2C_STATE_BUSY);
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
        ...
        case 0x40:  
            ...
            if((mI2C->Mode & MID_I2C_MODE_DMA_MRX) != 0)
            {
                ...
                ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x08) | ((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40)));
                mI2C->Instance->CR0.W |= ((uint32_t)0x40000000);
                __isb(0xF);
                break;
            }
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
        ...
        case 0x50:  
            mI2C->pBuffPtr[mI2C->XferCount] = ((mI2C)->Instance ->SBUF . B[0]);
            mI2C->XferCount++;
            if(mI2C->XferCount >= (mI2C->XferSize - 1))
                ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40)));
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
        ...
        case 0x78:  
            ...
            if((mI2C->Instance->INT.W & ((uint32_t)0x00000002)) != 0)
                MID_I2C_AddrCallback(mI2C, (0x00000001U), (mI2C->Instance->SAC.H[0] & 0xFFFE));

            ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40) | ((uint8_t )0x04)));
            ((mI2C)->Instance ->INT . W &= (~(((uint32_t)0x00000002))));
            ((mI2C)->Instance ->STA . W = (((uint32_t)0x00400000) | ((uint32_t)0x00000008)));
            mI2C->State &= ~MID_I2C_STATE_BUSY;
            break;
        ...
        case 0xB0:  
            ...
            if((mI2C->Instance->INT.W & ((uint32_t)0x00000002)) != 0)
                MID_I2C_AddrCallback(mI2C, (0x00000000U), (mI2C->Instance->SAC.H[0] & 0xFFFE));
...
static MID_StatusTypeDef I2C_Master_ISR_IT(struct __I2C_HandleTypeDef *mI2C, uint32_t ITFlags, uint32_t ITSources)
{
    ...
    if(((mI2C->Instance->CR0.W & ((uint32_t)0x00000040)) == 0) && ((ITFlags & ((uint32_t)0x00000002)) != 0))
    {
        I2C_BytemodeMasterEventHandle(mI2C);
    }

    if(((ITFlags & ((uint32_t)0x00000010)) != 0) && ((ITSources & ((uint32_t)0x00000010)) != 0))
    {
...
static MID_StatusTypeDef I2C_BytemodeSlaveEventHandle(I2C_HandleTypeDef *mI2C)
{
    ...
    switch(lState){
        ...
        case 0x70:  
            ...
            {
                ((mI2C)->Instance ->CR2 . B[0] = (((uint8_t )0x08) | ((uint8_t )0x10) | ((uint8_t )0x20) | ((uint8_t )0x40) | ((uint8_t )0x04)));
                mI2C->Instance->CR0.W |= ((uint32_t)0x40000000);
                __isb(0xF);
            }
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
        ...
        case 0xA0:  
            ...
            {
                if((mI2C->hdmarx->Instance->CH0CNT.W == 0) && ((mI2C->hdmarx->Instance->CH0A.W & ((uint32_t)0x00008000)) != 0))
        ...
        case 0xC0:  
            ...
            ((mI2C)->Instance ->INT . W &= (~(((uint32_t)0x00000002))));
            ((mI2C)->Instance ->STA . W = ((((uint32_t)0x00200000) | ((uint32_t)0x00000008))));
            ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
            I2C_ListenP(mI2C);
            mI2C->State &= ~MID_I2C_STATE_BUSY;
            break;
        ...
        case 0xC8:  
            ...
            do{
                if((mI2C->Instance->STA2.B[1] & ((uint8_t )0x01)) != 0)
                {
                    mI2C->XferCount ++;
                    ((mI2C)->Instance ->STA2 . B[1] = ((uint8_t )0x01));
                }
            }while(((mI2C)->Instance ->STA2 . B[0] & 0xF8) == 0xC8);
...
{
    uint32_t ltemp32;
    while((((((mI2C)->Instance ->STA . W) & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))) ? SET : CLR) == CLR)
    {
        ...
        if((Timeout != 0xFFFFFFFFU) && (Timeout != 0U))
        {
...
static void I2C_DMACplt(DMA_HandleTypeDef *mDMA)
{
    I2C_HandleTypeDef *lmI2C = (I2C_HandleTypeDef *)(((DMA_HandleTypeDef *)mDMA)->Parent);

    if((lmI2C->Mode & MID_I2C_MODE_DMA_SRX) != 0)
        lmI2C->XferCount = lmI2C->XferSize - 1;
    else
        lmI2C->XferCount = lmI2C->XferSize;

    lmI2C->Mode &= ~(MID_I2C_MODE_DMA_MTX | MID_I2C_MODE_DMA_MRX | MID_I2C_MODE_DMA_SRX | MID_I2C_MODE_DMA_STX);
}
...
static void I2C_DMAError(DMA_HandleTypeDef *mDMA)
{
    ...
    lmI2C->XferCount = (uint16_t)mDMA->DMAChannelIndex->CNT.W;
