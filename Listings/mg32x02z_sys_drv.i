#line 1 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_SYS_DRV.c"
...
#line 29 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_SYS_DRV.c"
...
void SYS_ITEA_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {    
        ((SYS_Struct*) ((uint32_t)0x4C030000))->INT.B[0] = 0x01; 
    }
    else
    {
        ((SYS_Struct*) ((uint32_t)0x4C030000))->INT.B[0] = 0x00;
    }
}
...
uint32_t SYS_GetChipMID (void)
{
    return ((SYS_Struct*) ((uint32_t)0x4C030000))->MID.W;
}
...
uint8_t SYS_ReadGeneralReg (void)
{
    return ((SYS_Struct*) ((uint32_t)0x4C030000))->CR0.B[2];
}
...
void SYS_WriteGeneralReg (uint8_t SYS_Value)
{
    ((SYS_Struct*) ((uint32_t)0x4C030000))->CR0.B[2] = SYS_Value;
}

#line 168 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_SYS_DRV.c"
