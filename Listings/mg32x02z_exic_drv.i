...
#line 38 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_EXIC_DRV.c"
...
DRV_Return EXIC_PxTriggerMode_Select(EXIC_PX_Struct* EXIC_PX ,EXIC_TRGSTypeDef* EXIC_PX_TRGS )
{
    ...
    if((EXIC_PX_TRGS->EXIC_Pin & (~0x55555555))!=0)
    {
        return(DRV_Failure);
    }
...
void EXIC_PxTriggerAndUnmatch_Cmd(uint32_t EXIC_PX_IT, FunctionalState PX_unMatch_Cmd)
{
    ...
    {
        ((EXIC_Struct*) ((uint32_t)0x50000000))->CR0.B[3] = ((EXIC_Struct*) ((uint32_t)0x50000000))->CR0.B[3] | (uint8_t) EXIC_PX_IT;
    }
    else
    {
        ((EXIC_Struct*) ((uint32_t)0x50000000))->CR0.B[3] = ((EXIC_Struct*) ((uint32_t)0x50000000))->CR0.B[3] & ((uint8_t) (~EXIC_PX_IT));
...
{    
    ...
    {
        ((EXIC_Struct*) ((uint32_t)0x50000000))->INT.W = ((EXIC_Struct*) ((uint32_t)0x50000000))->INT.W | EXIC_PX_IT;
    }
    else
    {
        ((EXIC_Struct*) ((uint32_t)0x50000000))->INT.W = ((EXIC_Struct*) ((uint32_t)0x50000000))->INT.W & (~EXIC_PX_IT);
...
uint8_t EXIC_GetPxAllTriggerITFlagStatus( EXIC_ITFlag_Typdef EXIC_PX_ITFlag)
{
    ...
    Tmp = ((EXIC_Struct*) ((uint32_t)0x50000000))->STA.H[0];
    Tmp = ((EXIC_Struct*) ((uint32_t)0x50000000))->STA.H[0] >> (4 * EXIC_PX_ITFlag);
    Tmp = Tmp & ((uint8_t )0x02) | ((uint8_t )0x01);
    return(Tmp);
}
...
DRV_Return EXIC_GetPxTriggerAndITFlagStatus( EXIC_ITFlag_Typdef EXIC_PX_ITFlag)      
{
    ...
    PX_AF_CMP = ((EXIC_Struct*) ((uint32_t)0x50000000))->STA.H[0];
    PX_AF_CMP = ((EXIC_Struct*) ((uint32_t)0x50000000))->STA.H[0] >> (4 * EXIC_PX_ITFlag);
    PX_AF_CMP = PX_AF_CMP & ((uint8_t )0x02);
...
DRV_Return EXIC_GetPxTriggerOrITFlagStatus( EXIC_ITFlag_Typdef EXIC_PX_ITFlag)    
{
    ...
    PX_OF_CMP = ((EXIC_Struct*) ((uint32_t)0x50000000))->STA.H[0];
    PX_OF_CMP = ((EXIC_Struct*) ((uint32_t)0x50000000))->STA.H[0] >> (4 * EXIC_PX_ITFlag);
    PX_OF_CMP = PX_OF_CMP & ((uint8_t )0x01);
...
void EXIC_ClearPxTriggerITFlag( EXIC_ITFlag_Typdef EXIC_PX , uint8_t EXIC_PX_ITFlag)
{
    ...
    PX_ITF_CLR = ( EXIC_PX_ITFlag << (4 * EXIC_PX));
    
    ((EXIC_Struct*) ((uint32_t)0x50000000))->STA.H[0] = PX_ITF_CLR;
}
...
uint8_t EXIC_GetITSourceID(IRQn_Type ITSourceNum)
{
    ...
    tmp = *((volatile uint8_t*)((uint32_t)0x50000060 + ITSourceNum));
    return(tmp);
}
...
void EXIC_RXEV_Cmd(FunctionalState RXEV_State)
{
    ((EXIC_Struct*) ((uint32_t)0x50000000))->CR0.MBIT.EM_RXEV = RXEV_State;
}
...
void EXIC_NMI_Cmd(FunctionalState NMI_State)
{
    ((EXIC_Struct*) ((uint32_t)0x50000000))->CR0.MBIT.EM_NMI = NMI_State;
}
...
void EXIC_NMITrigger_SW(void)
{
    ((EXIC_Struct*) ((uint32_t)0x50000000))->CR0.MBIT.NMI_SW = ENABLE;
}

#line 555 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_EXIC_DRV.c"
