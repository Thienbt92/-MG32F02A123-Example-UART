...
#line 30 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_RST_DRV.c"
...
uint32_t RST_GetAllFlagStatus (void)
{
    return ((RST_Struct*) ((uint32_t)0x4C000000))->STA.W;
}
...
{                                                                           
    ...
    if ((((RST_Struct*) ((uint32_t)0x4C000000))->STA.W & RST_FLAG) != (uint32_t)CLR)
    {
...
void RST_ClearFlag (uint32_t RST_FLAG)
{
    ((RST_Struct*) ((uint32_t)0x4C000000))->STA.W = RST_FLAG;
}
...
void RST_CRstSource_Config (uint32_t RST_CRS, FunctionalState NewState) 
{
    ...
    Reg_32 = ((RST_Struct*) ((uint32_t)0x4C000000))->CE.W;
    ...
    ((RST_Struct*) ((uint32_t)0x4C000000))->CE.W = Reg_32;
}
...
void RST_WRstSource_Config (uint32_t RST_WRS, FunctionalState NewState) 
{
    ...
    Reg_32 = ((RST_Struct*) ((uint32_t)0x4C000000))->WE.W;
    ...
    ((RST_Struct*) ((uint32_t)0x4C000000))->WE.W = Reg_32;
}
...
void RST_WRstGPIOLock_Config (uint32_t RST_Px_DISx, FunctionalState NewState)
{
    ...
    Reg = ((RST_Struct*) ((uint32_t)0x4C000000))->CR0.W;
    ...
    ((RST_Struct*) ((uint32_t)0x4C000000))->CR0.W = Reg;
...
void RST_ForceRstPeriph_SW (RST_SoftForceReset_Type ForceReset, FunctionalState NewState)
{
    ...
    if(ForceReset < 32)
    {
        ...
        if(NewState != DISABLE)
        {
            ((RST_Struct*) ((uint32_t)0x4C000000))->AHB.W |= Reg;
        }
        else
        {
            ((RST_Struct*) ((uint32_t)0x4C000000))->AHB.W &= ~Reg;
    ...
    if((32 <=ForceReset) & (ForceReset < 64))
    {
        ...
        if(NewState != DISABLE)
        {
            ((RST_Struct*) ((uint32_t)0x4C000000))->APB0.W |= Reg;
        }
        else
        {
            ((RST_Struct*) ((uint32_t)0x4C000000))->APB0.W &= ~Reg;
    ...
    if((64 <=ForceReset) & (ForceReset < 96))
    {
        ...
        if(NewState != DISABLE)
        {
            ((RST_Struct*) ((uint32_t)0x4C000000))->APB1.W |= Reg;
        }
        else
        {
            ((RST_Struct*) ((uint32_t)0x4C000000))->APB1.W &= ~Reg;
...
void RST_TriggerSystemRst_SW (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((RST_Struct*) ((uint32_t)0x4C000000))->CR0.B[0] |= ((uint8_t )0x02);
    }
    else
    {
        ((RST_Struct*) ((uint32_t)0x4C000000))->CR0.B[0] &= ~((uint8_t )0x02);
...
void RST_WWDTWRstMask_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((RST_Struct*) ((uint32_t)0x4C000000))->CR0.B[3] |= ((uint8_t )0x01);
    }
    else
    {
        ((RST_Struct*) ((uint32_t)0x4C000000))->CR0.B[3] &= ~((uint8_t )0x01);
...
#line 489 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_RST_DRV.c"
