...
#line 33 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_GPIO_DRV.c"
...
void GPIO_PinMode_Config(Pin_Struct* PINX , PIN_InitTypeDef* PINX_InitStruct)
{
	PINX->CR.W = (PINX_InitStruct->PINX_Mode | PINX_InitStruct->PINX_Speed | 
				   PINX_InitStruct->PINX_PUResistant|PINX_InitStruct->PINX_Inverse|
	               PINX_InitStruct->PINX_OUTDrive|PINX_InitStruct->PINX_FilterDivider|
	               (PINX_InitStruct->PINX_Alternate_Function<<12)|((uint32_t)0x80000000));
}
...
void GPIO_PortMode_Config(IOM_Struct* IOMX, PIN_InitTypeDef* PINX_InitStruct)
{
    ...
    while(set_pin!=0)
    {
		...
		{
            *((volatile uint32_t*)((uint32_t)IOMX + 0x04*pin_pos)) =   (PINX_InitStruct->PINX_Mode | PINX_InitStruct->PINX_Speed | 
																	    PINX_InitStruct->PINX_PUResistant|PINX_InitStruct->PINX_Inverse|
																	    PINX_InitStruct->PINX_OUTDrive|PINX_InitStruct->PINX_FilterDivider|
																	   (PINX_InitStruct->PINX_Alternate_Function<<12)|((uint32_t)0x80000000));
...
void GPIO_PinMode_Select(Pin_Struct* PINX , PINX_Mode_TypeDef Pin_Mode)
{
    PINX->CR.W = PINX->CR.W & (~((uint32_t)0x00000007));
...
void GPIO_PinOutputDrive_Select(Pin_Struct* PINX , PINX_OUTDrive_Typedef Pin_ODC)
{
    PINX->CR.W = PINX->CR.W & (~((uint32_t)0x00000300));
...
void GPIO_PinInFilterDivider_Select(Pin_Struct* PINX , PINX_FilterDiver_Typedef Pin_FDIV)
{
    PINX->CR.W = PINX->CR.W & (~((uint32_t)0x00000C00));
...
void GPIO_PinFunction_Select(Pin_Struct* PINX , uint8_t Pin_Func)
{
    ...
    tmp = PINX->CR.W & (~((uint32_t)0x0000F000));
    tmp = tmp | (Pin_Func << 12) | ((uint32_t)0x80000000);
    PINX->CR.W = tmp;
...
void GPIO_SetClearPortBit(GPIO_Struct* GPIOX, uint16_t Set_Pin , uint16_t Clr_Pin)
{
    ...
    GPIOX->SC.W = (((Clr_Pin<<16) & 0xFFFF0000) | Set_Pin);
