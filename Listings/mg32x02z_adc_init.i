...
#line 29 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_ADC_Init.c"
...
void ADC_Init (void)
{
    ...
    ((ADC_Struct*) ((uint32_t)0x5B000000))->CLK.W     = (0x00000000 | 0x00000000);
    ((ADC_Struct*) ((uint32_t)0x5B000000))->WINDTH.W  = ((0 << 16) | 0); 
    ((ADC_Struct*) ((uint32_t)0x5B000000))->CR0.W     = (0 | 0x0000) | ((uint32_t)0x00000001);  
    ((ADC_Struct*) ((uint32_t)0x5B000000))->CR1.W     = (0x00000000 | 0x00000000 | 1024);  
    ((ADC_Struct*) ((uint32_t)0x5B000000))->MSK.W     = (0x00000000 | 0x0000);  
    ((ADC_Struct*) ((uint32_t)0x5B000000))->START.W   = (0x00000000 | 0x000000);
    ((ADC_Struct*) ((uint32_t)0x5B000000))->ANA.W     = (0);  
    ((ADC_Struct*) ((uint32_t)0x5B000000))->GAIN.W    = (0); 
    ((ADC_Struct*) ((uint32_t)0x5B000000))->SUM0.W    = 0;
    ((ADC_Struct*) ((uint32_t)0x5B000000))->SUM1.W    = 0;
    ((ADC_Struct*) ((uint32_t)0x5B000000))->SUM2.W    = 0;
    ...
    ADC_StartCalibration(((ADC_Struct*) ((uint32_t)0x5B000000)), ENABLE); 
