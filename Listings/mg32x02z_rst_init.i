...
#line 30 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_RST_Init.c"
...
void RST_Init (void)
{
    ...
    ((RST_Struct*) ((uint32_t)0x4C000000))->CR0.W = CONF_RST_InitConfig[3];
    ((RST_Struct*) ((uint32_t)0x4C000000))->CE.W = CONF_RST_InitConfig[4];
    ((RST_Struct*) ((uint32_t)0x4C000000))->WE.W = CONF_RST_InitConfig[5];
    ((RST_Struct*) ((uint32_t)0x4C000000))->AHB.W = CONF_RST_InitConfig[6];
    ((RST_Struct*) ((uint32_t)0x4C000000))->APB0.W = CONF_RST_InitConfig[7];
    ((RST_Struct*) ((uint32_t)0x4C000000))->APB1.W = CONF_RST_InitConfig[8];
    ((RST_Struct*) ((uint32_t)0x4C000000))->KEY.H[0] = 0x0000;
}
