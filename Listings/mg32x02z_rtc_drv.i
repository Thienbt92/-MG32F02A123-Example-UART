...
#line 30 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_RTC_DRV.c"
...
void RTC_CLK_Select (RTC_CLKS_TypeDef RTC_CLKS)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CLK.MBIT.CK_SEL = RTC_CLKS;
}
...
void RTC_PreDivider_Select (RTC_PDIVS_TypeDef RTC_PDIV)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CLK.MBIT.CK_PDIV = RTC_PDIV;
}
...
void RTC_Divider_Select (RTC_DIVS_TypeDef RTC_DIV)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CLK.MBIT.CK_DIV = RTC_DIV;
}
...
uint32_t RTC_GetAlarmCompareValue (void)
{
    return ((RTC_Struct*) ((uint32_t)0x5D040000))->ALM.W;
}
...
void RTC_SetAlarmCompareValue (uint32_t RTC_ALM)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->ALM.W = RTC_ALM;
}
...
DRV_Return RTC_GetAlarmState (void)
{
    ...
    if(((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.MBIT.ALM_EN != 0)
        bitstatus = DRV_True;
...
void RTC_Alarm_Cmd (FunctionalState NewState)
{
    ...
    Reg = ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.B[0];
    if(NewState != DISABLE)
    {
        Reg |= ((uint8_t )0x02);
    }
    ...
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.B[0] = Reg;
}
...
uint32_t RTC_GetReloadReg (void)
{ 
    return ((RTC_Struct*) ((uint32_t)0x5D040000))->RLR.W;
}
...
uint32_t RTC_GetCaptureReg (void)
{ 
    return ((RTC_Struct*) ((uint32_t)0x5D040000))->CAP.W;
}
...
void RTC_SetReloadReg (uint32_t RTC_RCR)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->RLR.W = RTC_RCR;
}
...
void RTC_RCR_Mode_Select (RTC_RCR_MODS_TypeDef RTC_MODS)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.MBIT.RCR_MDS = RTC_MODS;
}
...
void RTC_StopModeWakeUpEvent_Config (uint32_t RTC_WK, FunctionalState NewState)
{
    ...
    Reg = ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.W;
    if(NewState != DISABLE)
    {
        Reg |= RTC_WK;
    }
    ...
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.W = Reg;
}
...
void RTC_OutputSignal_Select (RTC_OUTS_TypeDef RTC_OUTS)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.MBIT.OUT_SEL = RTC_OUTS;
}
...
void RTC_InitOutputSignalState_Cmd (FunctionalState NewState)
{
    ...
    Reg = ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.B[1];
    if(NewState != DRV_Logic0)
    {
        Reg |= ((uint8_t )0x40);
    }
    else
    ...
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.B[1] = Reg;
}
...
void RTC_TriggerStamp_Select (RTC_TS_TRGS_TypeDef RTC_TSS)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CR0.MBIT.TS_TRGS = RTC_TSS;
}
...
void RTC_TriggerStamp_SW (void)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->CR1.B[0] = ((uint8_t )0x01);
}
...
uint32_t RTC_GetAllFlagStatus (void)
{
    return ((RTC_Struct*) ((uint32_t)0x5D040000))->STA.W;
}
...
DRV_Return RTC_GetSingleFlagStatus (uint32_t RTC_Flag)
{
    ...
    if ((((RTC_Struct*) ((uint32_t)0x5D040000))->STA.W & RTC_Flag) != (uint32_t)DRV_Normal)
    {
...
void RTC_ClearFlag (uint32_t RTC_Flag)
{
    ((RTC_Struct*) ((uint32_t)0x5D040000))->STA.W = RTC_Flag;
}
...
void RTC_IT_Config (uint32_t RTC_INT, FunctionalState NewState)
{
    ...
    Reg = ((RTC_Struct*) ((uint32_t)0x5D040000))->INT.W;
    if(NewState != DISABLE)
    {
        Reg |= RTC_INT;
    }
    ...
    ((RTC_Struct*) ((uint32_t)0x5D040000))->INT.W = Reg;
}
...
void RTC_ITEA_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((RTC_Struct*) ((uint32_t)0x5D040000))->INT.MBIT.IEA = 1;
    }
    else
    {
        ((RTC_Struct*) ((uint32_t)0x5D040000))->INT.MBIT.IEA = 0;
    }
}
