...
#line 30 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
...
#line 31 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
...
#line 56 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
...
#line 109 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"

#line 130 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
...
#line 151 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"




 
#line 178 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"



 
#line 237 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
...
void CSC_IHRCO_Enable(uint32_t *CSC_CFG)
{
    ...
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.IHRCO_SEL = CSC_SET.CR0.MBIT.IHRCO_SEL;
    
    if(((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.IHRCO_EN == 0)
    {
        
        ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.IHRCO_EN = 1;
    }
    

    
    while(((CSC_Struct*) ((uint32_t)0x4C010000))->STA.MBIT.IHRCOF == 0);
    ...
    ((CSC_Struct*) ((uint32_t)0x4C010000))->STA.B[0] = ((uint8_t )0x20);
}
...
void CSC_XOSC_Enable(uint32_t *CSC_CFG)
{
    ...
    ((CSC_Struct*) ((uint32_t)0x4C010000))->AHB.MBIT.IOPC_EN = 1;
    if((((IOM_Struct*) ((uint32_t)0x44020000))->CR13.H[0] != 0x1000)||(((IOM_Struct*) ((uint32_t)0x44020000))->CR14.H[0] != 0x1000))
    {
        
        ((IOM_Struct*) ((uint32_t)0x44020000))->CR13.H[0] = 0x1000;
        ((IOM_Struct*) ((uint32_t)0x44020000))->CR14.H[0] = 0x1000;
    }
    

        
        while(((CSC_Struct*) ((uint32_t)0x4C010000))->STA.MBIT.XOSCF == 0);
    ...
    ((CSC_Struct*) ((uint32_t)0x4C010000))->STA.B[0] = ((uint8_t )0x02);

    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.MCD_SEL = CSC_SET.CR0.MBIT.MCD_SEL;
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.MCD_DIS = CSC_SET.CR0.MBIT.MCD_DIS;
...
void CSC_EXTCK_Enable(uint32_t *CSC_CFG)
{
    ...
    ((IOM_Struct*) ((uint32_t)0x44020000))->CR13.H[0] = 0x0003;
    
    ((IOM_Struct*) ((uint32_t)0x44020000))->CR14.H[0] = 0x0000;
}
...
void CSC_Init (uint32_t* CSC_CFG)
{
    ...
    ((MEM_Struct*) ((uint32_t)0x4D000000))->CR0.W = (((MEM_Struct*) ((uint32_t)0x4D000000))->CR0.W & (~((uint32_t)0x00003000))) | CSC_CFG[19];

    ((MEM_Struct*) ((uint32_t)0x4D000000))->KEY.MBIT.KEY = 0x0000;
    
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->KEY.MBIT.KEY = 0xA217;
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->DIV.W = CSC_SET.DIV.W;
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->PLL.W = CSC_SET.PLL.W;
    ...
    {
        ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.MCD_DIS = 1;
    }
    
    else
    {
        if(0x00000010==0x00000000)
        {
            ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.MCD_DIS = 0;
        }
    }
...
#line 434 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
...
#line 459 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
        ...
        if((fXOSC&0x01) != 1)
        {
            ...
            {
                if(((IOM_Struct*) ((uint32_t)0x44020000))->CR13.H[0] != 0x0003)
                    CSC_EXTCK_Enable((uint32_t *)&CSC_InitConfig);
            }
        
#line 480 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
        }
...
#line 520 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
    
     
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.HS_SEL = CSC_SET.CR0.MBIT.HS_SEL;




    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.LS_SEL = CSC_SET.CR0.MBIT.LS_SEL;
    ...
    if(CSC_SET.CR0.MBIT.MAIN_SEL == 2)
    {
        ...
        ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.PLL_EN = 1;
#line 570 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
        ...
        ((CSC_Struct*) ((uint32_t)0x4C010000))->STA.B[0] = ((uint8_t )0x40);
    }
    

#line 607 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.MAIN_SEL = CSC_SET.CR0.MBIT.MAIN_SEL;     
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.ST_SEL= CSC_SET.CR0.MBIT.ST_SEL;          
    ((CSC_Struct*) ((uint32_t)0x4C010000))->DIV.W = CSC_SET.DIV.W;                             
    ...
    ((CSC_Struct*) ((uint32_t)0x4C010000))->INT.W = CSC_CFG[1];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CKO.W = CSC_CFG[6];
    
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->AHB.W = CSC_CFG[7];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->APB0.W = CSC_CFG[8];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->APB1.W = CSC_CFG[9];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->SLP0.W = CSC_CFG[10];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->SLP1.W = CSC_CFG[11];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->STP0.W = CSC_CFG[12];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CKS0.W = CSC_CFG[14];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CKS1.W = CSC_CFG[15];
    ((CSC_Struct*) ((uint32_t)0x4C010000))->CKS2.W = CSC_CFG[16];
    ...
    if(((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.HS_SEL != 0)
        ((CSC_Struct*) ((uint32_t)0x4C010000))->CR0.MBIT.IHRCO_EN = 0;

    
#line 656 "RTE\\MG32x02z_ChipInit_Wizard\\MG32F02A132\\MG32x02z_CSC_Init.c"
    if((CSC_SET.CR0.MBIT.HS_SEL!= 1) && (CSC_SET.CR0.MBIT.LS_SEL != 1))
    {
        
        ((IOM_Struct*) ((uint32_t)0x44020000))->CR14.H[0] &= 0x0FFF;
        
        if((CSC_SET.CR0.MBIT.HS_SEL != 0x03) && (CSC_SET.CR0.MBIT.LS_SEL != 0x03))
            ((IOM_Struct*) ((uint32_t)0x44020000))->CR13.H[0] &= 0x0FFF;
    }

    
    
    ((CSC_Struct*) ((uint32_t)0x4C010000))->KEY.MBIT.KEY = 0x0000;
