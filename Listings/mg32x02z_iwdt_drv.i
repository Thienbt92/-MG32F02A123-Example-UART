...
#line 30 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_IWDT_DRV.c"
...
void IWDT_Divider_Select (IWDT_DIVS_TypeDef IWDT_DIVS)
{
    ((IWDT_Struct*) ((uint32_t)0x5D000000))->CLK.MBIT.CK_DIV = IWDT_DIVS;
}
...
uint8_t IWDT_GetCounter (void)
{
    return ((IWDT_Struct*) ((uint32_t)0x5D000000))->CNT.B[0];
}
...
void IWDT_RefreshCounter (void)
{
    ((IWDT_Struct*) ((uint32_t)0x5D000000))->KEY.H[0] = 0x2014;
}
...
void IWDT_StopModeWakeUpEvent_Config (uint32_t IWDT_WK, FunctionalState NewState)
{
    ...
    Reg = ((IWDT_Struct*) ((uint32_t)0x5D000000))->CR0.W;
    if(NewState != DISABLE)
    {
        Reg |= IWDT_WK;
    }
    ...
    ((IWDT_Struct*) ((uint32_t)0x5D000000))->CR0.W = Reg;
}
...
void IWDT_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((IWDT_Struct*) ((uint32_t)0x5D000000))->CR0.MBIT.EN = 1;
    }
    else
    {
        ((IWDT_Struct*) ((uint32_t)0x5D000000))->CR0.MBIT.EN = 0;
    }
}
...
uint32_t IWDT_GetAllFlagStatus (void)
{
    return ((IWDT_Struct*) ((uint32_t)0x5D000000))->STA.W;
}
...
DRV_Return IWDT_GetSingleFlagStatus (uint32_t IWDT_ITSrc)
{
    ...
    if ((((IWDT_Struct*) ((uint32_t)0x5D000000))->STA.W & IWDT_ITSrc) != (uint32_t)DISABLE)
    {
...
void IWDT_ClearFlag (uint32_t IWDT_ITSrc)
{
    ((IWDT_Struct*) ((uint32_t)0x5D000000))->STA.W = IWDT_ITSrc;
}
...
void IWDT_IT_Config (uint32_t IWDT_ITSrc, FunctionalState NewState)
{
    ...
    Reg = ((IWDT_Struct*) ((uint32_t)0x5D000000))->INT.W;
    ...
    ((IWDT_Struct*) ((uint32_t)0x5D000000))->INT.W = Reg;
}
