...
#line 32 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_WWDT_MID.c"
...
MID_StatusTypeDef MID_WWDT_Init(WWDT_HandleTypeDef *mWWDT)
{
    ...
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->KEY.W = 0xA217;
    
     
    MID_WWDT_MspInit(mWWDT);                        

     
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->RLR.W = mWWDT->Init.WWDT_RLR;             
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->KEY.W = 0x2014;                           

     
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->WIN.W = mWWDT->Init.WWDT_RLR;             
    
     
    ((mWWDT)->Instance ->INT . W = (mWWDT->Init . WWDT_INT_SEL));
    
     
    ((mWWDT)->Instance ->CR0 . W = ((uint32_t)0x00000001));
     
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->KEY.W = 0;
...
{
  if(mWWDT->Instance==((WWDT_Struct*) ((uint32_t)0x5D010000)))
  {
...
void MID_WWDT_IRQHandler(WWDT_HandleTypeDef *mWWDT)
{
    ...
    if((((mWWDT)->Instance ->INT . W & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))) != CLR)
    {
         
        if((((mWWDT)->Instance ->STA . W & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))) != CLR)
        {
             
            ((mWWDT)->Instance ->STA . W = (((uint32_t)0x00000002)));
    ...
    if((((mWWDT)->Instance ->INT . W & (((uint32_t)0x00000004))) == (((uint32_t)0x00000004))) != CLR)
    {
         
        if((((mWWDT)->Instance ->STA . W & (((uint32_t)0x00000004))) == (((uint32_t)0x00000004))) != CLR)
        {
             
            ((mWWDT)->Instance ->STA . W = (((uint32_t)0x00000004)));
    ...
    if((((mWWDT)->Instance ->INT . W & (((uint32_t)0x00000008))) == (((uint32_t)0x00000008))) != CLR)
    {
         
        if((((mWWDT)->Instance ->STA . W & (((uint32_t)0x00000008))) == (((uint32_t)0x00000008))) != CLR)
        {
             
            ((mWWDT)->Instance ->STA . W = (((uint32_t)0x00000008)));
