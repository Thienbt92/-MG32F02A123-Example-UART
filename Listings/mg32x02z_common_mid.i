...
#line 70 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_Common_MID.c"
...
volatile uint32_t static uwTick;
...
__weak MID_StatusTypeDef MID_InitTick(uint32_t TickPriority)
{
    ...
    MID_NVIC_SetPriority(SysTick_IRQn, TickPriority ,0U);
...
__weak void MID_Delay(volatile uint32_t Delay)
{
