...
#line 31 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_PW_DRV.c"
...
void PW_STOPModeLDO_Select (PW_LDOMode_TypeDef LdoSelect)
{
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.LDO_STP = LdoSelect;
}
...
void PW_ONModeLDO_Select (PW_LDOMode_TypeDef LdoSelect)
{
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.LDO_ON = LdoSelect;
}
...
#line 107 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_PW_DRV.c"

#line 136 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_PW_DRV.c"

#line 167 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_PW_DRV.c"
...
void PW_BOD1Threshold_Select (PW_BOD1_TH_TypeDef BOD1_TH)
{
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.BOD1_TH = BOD1_TH;
}
...
void PW_BOD1Trigger_Select (PW_BODx_TRGS_TypeDef BOD1_TRGS)
{
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.BOD1_TRGS = BOD1_TRGS;
}
...
void PW_BOD1_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.BOD1_EN = SET;
    }
    else
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.BOD1_EN = CLR;
    }
}
...
void PW_VoltageBuffer (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.IVR_EN = SET;
    }
    else
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.IVR_EN = CLR;
    }
}
...
void PW_BOD0_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.BOD0_EN = SET;
    }
    else
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.BOD0_EN = CLR;
    }
}
...
{    
    ...
    if((((PW_Struct*) ((uint32_t)0x4C020000))->STA.MBIT.BOD1_S) != 0)
    {
...
void PW_PeriphSLEEPModeContinuous_Config (PW_SLP_Periph_TypeDef SLP_Periph, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR1.W |= SLP_Periph;
    }
    else
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR1.W &= ~SLP_Periph;
...
void PW_PeriphSTOPModeContinuous_Config (PW_STP_Periph_TypeDef STP_Periph,FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR1.W |= STP_Periph;
    }
    else
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->CR1.W &= ~STP_Periph;
...
void PW_PeriphSTOPModeWakeUp_Config (PW_WKSTP_Periph_TypeDef WKSTP_Periph, FunctionalState NewState)
{
    ...
    if(WKSTP_Periph < 32)
    {
        ...
        if(NewState != DISABLE)
        {
            ((PW_Struct*) ((uint32_t)0x4C020000))->WKSTP0.W |= REG;
        }
        else
        {
            ((PW_Struct*) ((uint32_t)0x4C020000))->WKSTP0.W &= ~REG;
    ...
    else
    {
        ...
        if(NewState != DISABLE)
        {
            ((PW_Struct*) ((uint32_t)0x4C020000))->WKSTP1.W |= REG;
        }
        else
        {
            ((PW_Struct*) ((uint32_t)0x4C020000))->WKSTP1.W &= ~REG;
...
void PW_WakeUpDelay_Select (PW_WakeUpDly_TypeDef WakeUpDly)
{
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.MBIT.WKSTP_DSEL = WakeUpDly;
}
...
DRV_Return PW_GetWakeUpMode (void)
{
    ...
    if(((PW_Struct*) ((uint32_t)0x4C020000))->STA.MBIT.BOD1_S == 1)
    {
        bitstatus = PW_Sleep;
    }
    
    if(((PW_Struct*) ((uint32_t)0x4C020000))->STA.MBIT.BOD1_S == 2)
    {
        bitstatus = PW_Stop;
    }
    return bitstatus;
...
#line 547 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_PW_DRV.c"
...
uint32_t PW_GetAllFlagStatus (void)
 {
    return ((PW_Struct*) ((uint32_t)0x4C020000))->STA.W;
 }
...
DRV_Return PW_GetSingleFlagStatus (uint32_t PW_ITSrc)
{
    ...
    if((((PW_Struct*) ((uint32_t)0x4C020000))->STA.W & PW_ITSrc) != 0)
    {
...
void PW_ClearFlag (uint32_t PW_ITSrc)
{
    ((PW_Struct*) ((uint32_t)0x4C020000))->STA.W = PW_ITSrc;
}
...
void PW_IT_Config (uint32_t PW_ITSrc, FunctionalState NewState)
{
    ...
    Reg = ((PW_Struct*) ((uint32_t)0x4C020000))->INT.W;
    ...
    ((PW_Struct*) ((uint32_t)0x4C020000))->INT.W = Reg;
}
...
void PW_ITEA_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->INT.MBIT.IEA = SET;
    }
    else
    {
        ((PW_Struct*) ((uint32_t)0x4C020000))->INT.MBIT.IEA = CLR;
    }
}
