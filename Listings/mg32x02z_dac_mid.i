...
#line 33 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_DAC_MID.c"
...
MID_StatusTypeDef MID_DAC_DeInit(DAC_HandleTypeDef *mDAC)
{
    ...
    do{ if((mDAC)->Lock == MID_Locked) { return MID_BUSY; } else { (mDAC)->Lock = MID_Locked; } }while (0);
    ...
    do{ (mDAC)->Lock = MID_UnLocked; }while (0);
...
MID_StatusTypeDef MID_DAC_Start(DAC_HandleTypeDef* mDAC)
{
    ...
    ((mDAC)->Instance ->CR0 . W |= ((uint32_t)0x00000001));
...
MID_StatusTypeDef MID_DAC_Start_IT(DAC_HandleTypeDef* mDAC)
{
    ...
    else
    {
        ...
        (((DAC_Struct*) ((uint32_t)0x5C080000))->INT . W |= ((uint32_t)0x00000001));
...
MID_StatusTypeDef MID_DAC_Start_DMA(DAC_HandleTypeDef* mDAC, uint32_t* pData, uint32_t Length)
{
    ...
    ((mDAC)->Instance ->STA . W = ((((uint32_t)0x00000002) | ((uint32_t)0x00000080))));

     
    ((mDAC)->Instance ->INT . W |= (((uint32_t)0x00000080)));

     
    ((mDAC)->Instance ->CR0 . W |= (((uint32_t)0x80000000)));
    ...
    ((mDAC->DMA_Handle ->DMAChannelIndex)->A . W |= ((uint32_t)0x00008000));
...
void MID_DAC_IRQHandler(DAC_HandleTypeDef* mDAC)
{
    if((((mDAC)->Instance ->INT . W & (((uint32_t)0x00000080))) == (((uint32_t)0x00000080))))
    { 
         
        if((((mDAC)->Instance ->STA . W & (((uint32_t)0x00000080))) == (((uint32_t)0x00000080))))
        {
        ...
        ((mDAC)->Instance ->STA . W = (((uint32_t)0x00000080)));
    ...
    if((((mDAC)->Instance ->INT . W & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))))
    { 
         
        if((((mDAC)->Instance ->STA . W & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))))
        {
        ...
        ((mDAC)->Instance ->STA . W = (((uint32_t)0x00000002)));
...
MID_StatusTypeDef MID_DAC_SetValue(DAC_HandleTypeDef* mDAC, uint32_t Data)
{
    ...
    {    
#line 572 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_DAC_MID.c"
    case ((uint32_t)0x00000000) | ((uint32_t)0x00000000):
        mDAC->Instance->DAT0.H[0] = Data;
        break;
    case ((uint32_t)0x00000000) | ((uint32_t)0x00000010):
        mDAC->Instance->DAT0.H[0] = Data << 6;
        break;
    case ((uint32_t)0x00000040) | ((uint32_t)0x00000000):
        mDAC->Instance->DAT0.H[0] = Data & 0x00FF;
        break;
    case ((uint32_t)0x00000040) | ((uint32_t)0x00000010):
        mDAC->Instance->DAT0.H[0] = Data << 8;
        break;
    default:
        return MID_FAILURE;
