...
#line 30 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_WWDT_DRV.c"
...
void WWDT_CLK_Select(WWDT_CLKS_TypeDef WWDT_CLKS)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->CLK.MBIT.CK_SEL = WWDT_CLKS;
}
...
void WWDT_DIV_Select (WWDT_DIVS_TypeDef WWDT_DIVS)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->CLK.MBIT.CK_DIV = WWDT_DIVS;
}
...
void WWDT_PDIV_Select (WWDT_PDIVS_TypeDef WWDT_PDIVS)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->CLK.MBIT.CK_PDIV = WWDT_PDIVS;
}
...
void WWDT_Cmd (FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        ((WWDT_Struct*) ((uint32_t)0x5D010000))->CR0.MBIT.EN = 1;
    }
    else
    {
        ((WWDT_Struct*) ((uint32_t)0x5D010000))->CR0.MBIT.EN = 0;
    }
}
...
uint16_t WWDT_GetCounter (void)
{
    return ((WWDT_Struct*) ((uint32_t)0x5D010000))->CNT.H[0];
} 
...
void WWDT_RefreshCounter (void)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->KEY.H[0] = 0x2014;
}
...
uint16_t WWDT_GetReloadReg (void)
{
    return ((WWDT_Struct*) ((uint32_t)0x5D010000))->RLR.H[0];
}
...
void WWDT_SetReloadReg (uint16_t WWDT_RLR)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->RLR.H[0] = WWDT_RLR;
}
...
uint16_t WWDT_GetWindowThreshold (void)
{
    return ((WWDT_Struct*) ((uint32_t)0x5D010000))->WIN.H[0];
}
...
void WWDT_SetWindowThreshold (uint16_t WWDT_WIN)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->WIN.H[0] = WWDT_WIN;
}
...
uint16_t WWDT_GetWarningThreshold (void)
{
    return ((WWDT_Struct*) ((uint32_t)0x5D010000))->WRN.H[0];
}
...
void WWDT_SetWarningThreshold (uint16_t WWDT_WRN)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->WRN.H[0] = WWDT_WRN;
}
...
void WWDT_RstEvent_Config (uint8_t WWDT_RSTGS, FunctionalState NewState)
{
    ...
    Reg = ((WWDT_Struct*) ((uint32_t)0x5D010000))->CR0.B[0];
    if(NewState != DISABLE)
    {
        Reg |= WWDT_RSTGS;
    }
    ...
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->CR0.B[0] = Reg;
}
...
uint32_t WWDT_GetAllFlagStatus (void)
{
    return ((WWDT_Struct*) ((uint32_t)0x5D010000))->STA.W;
}
...
DRV_Return WWDT_GetSingleFlagStatus (uint32_t WWDT_ITSrc)
{
    ...
    if ((((WWDT_Struct*) ((uint32_t)0x5D010000))->STA.W & WWDT_ITSrc) != (uint32_t)DISABLE)
    {
...
void WWDT_ClearFlag (uint32_t WWDT_ITSrc)
{
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->STA.W = WWDT_ITSrc;
}
...
void WWDT_IT_Config (uint32_t WWDT_ITSrc, FunctionalState NewState)
{
    ...
    Reg = ((WWDT_Struct*) ((uint32_t)0x5D010000))->INT.W;
    ...
    ((WWDT_Struct*) ((uint32_t)0x5D010000))->INT.W = Reg;
}
