...
#line 32 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_CMP_DRV.c"
...
void CMP_DeInit(void)
{
     ((CMP_Struct*) ((uint32_t)0x5C000000))->INT.W = 0x00000000;
     ((CMP_Struct*) ((uint32_t)0x5C000000))->ANA.W = 0x00000000;
     ((CMP_Struct*) ((uint32_t)0x5C000000))->CR0.W = 0x00000000;
     ((CMP_Struct*) ((uint32_t)0x5C000000))->CR1.W = 0x00000000;

     ((CMP_Struct*) ((uint32_t)0x5C000000))->CR2.W = 0x00000000;
     ((CMP_Struct*) ((uint32_t)0x5C000000))->CR3.W = 0x00000000;

     ((CMP_Struct*) ((uint32_t)0x5C000000))->STA.W = 0xFFFFFFFF;
}
...
DRV_Return CMP_IVREF_Select(CMP_Struct* CMPx, uint8_t RefSel)
{
    ...
    ((CMP_Struct*) ((uint32_t)0x5C000000))->ANA.MBIT.IVREF_RS = RefSel;
...
DRV_Return CMP_IVREF2_Select(CMP_Struct* CMPx, uint8_t RefSel)
{
    ...
    ((CMP_Struct*) ((uint32_t)0x5C000000))->ANA.MBIT.IVREF2_RS = RefSel;
    
    return DRV_Success;
}

#line 359 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_CMP_DRV.c"
...
#line 414 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_CMP_DRV.c"
...
#line 509 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_CMP_DRV.c"
...
DRV_Return CMP_GetOutput (CMPAC_Struct* CMPACx)
{
    ...
    RetBitV = DRV_Logic0; 
    if (CMPACx == ((CMPAC_Struct*) ((uint32_t)0x5C000010)))
    {
        if (((CMP_Struct*) ((uint32_t)0x5C000000))->STA.MBIT.AC0_S == SET)
            RetBitV = DRV_Logic1;
        else
            RetBitV = DRV_Logic0;
    }
    else if (CMPACx == ((CMPAC_Struct*) ((uint32_t)0x5C000014)))
    {
        if (((CMP_Struct*) ((uint32_t)0x5C000000))->STA.MBIT.AC1_S == SET)
            RetBitV = DRV_Logic1;
        else
            RetBitV = DRV_Logic0;
    }

    else if (CMPACx == ((CMPAC_Struct*) ((uint32_t)0x5C000018)))
        if (((CMP_Struct*) ((uint32_t)0x5C000000))->STA.MBIT.AC2_S == SET)
            RetBitV = DRV_Logic1;
        else
            RetBitV = DRV_Logic0;
    else 
        if (((CMP_Struct*) ((uint32_t)0x5C000000))->STA.MBIT.AC3_S == SET)
            RetBitV = DRV_Logic1;
        else
            RetBitV = DRV_Logic0;
