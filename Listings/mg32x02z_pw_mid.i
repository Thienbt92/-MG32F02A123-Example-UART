...
#line 29 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_PW_MID.c"
...
void MID_PW_DeInit (void)
{
    ((PW_Struct*) ((uint32_t)0x4C020000))->KEY.MBIT.KEY = 0xA217;
    ((PW_Struct*) ((uint32_t)0x4C020000))->STA.W = 0x000000FC;
    ((PW_Struct*) ((uint32_t)0x4C020000))->INT.W = 0x00000000;
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.W = 0x00000090;
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR1.W = 0x00000000;
    ((PW_Struct*) ((uint32_t)0x4C020000))->WKSTP0.W = 0x00000000;
    ((PW_Struct*) ((uint32_t)0x4C020000))->WKSTP1.W = 0x00000000;
    ((PW_Struct*) ((uint32_t)0x4C020000))->KEY.MBIT.KEY = 0;
}
...
void MID_PW_ConfigBOD1 (PW_BODxTypeDef *sConfigBOD1)
{
    ...
    REG = (((PW_Struct*) ((uint32_t)0x4C020000))->CR0.W & ~(((uint32_t)0x00000C00) | ((uint32_t)0x00000300)));
    REG |= ((sConfigBOD1->BODx_THRESHOLD << 10) | 
            (sConfigBOD1->BODx_TRIGGER << 8));
    ((PW_Struct*) ((uint32_t)0x4C020000))->CR0.W = REG;
}


#line 241 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_PW_MID.c"
...
void MID_PW_IRQHandler (void)
{
    uint32_t itsource = ((PW_Struct*) ((uint32_t)0x4C020000))->INT.W;
    uint32_t itflag   = ((PW_Struct*) ((uint32_t)0x4C020000))->STA.W;
    ...
    if((itieflag & ((uint32_t)0x00000010)) != CLR)
    {
        ...
        ((((PW_Struct*) ((uint32_t)0x4C020000))->STA . W) = ((uint32_t)0x00000010));
        MID_PW_BOD0Callback();
        return;
    }
    ...
    if((itieflag & ((uint32_t)0x00000020)) != CLR)
    {
        ...
        ((((PW_Struct*) ((uint32_t)0x4C020000))->STA . W) = ((uint32_t)0x00000020));
        MID_PW_BOD1Callback();
        return;
    }
 
#line 291 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_PW_MID.c"
    
     
    if((itieflag & ((uint32_t)0x00000080)) != CLR)
    {
        
        ((((PW_Struct*) ((uint32_t)0x4C020000))->STA . W) = ((uint32_t)0x00000080));
        MID_PW_WKCallback();
        return;
    }
}
...
#line 363 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_PW_MID.c"
