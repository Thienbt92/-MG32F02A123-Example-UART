...
#line 32 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_I2C_DRV.c"
...
void I2C_SetClockSource(I2C_Struct* I2Cx, uint8_t Select)
{
    I2Cx->CLK.B[1] = ((I2Cx->CLK.B[1] & (~((uint8_t )0x0C))) | Select);
}
...
void I2C_SetClockPrescaler(I2C_Struct* I2Cx, uint8_t Select)
{
    I2Cx->CLK.B[1] = ((I2Cx->CLK.B[1] & (~((uint8_t )0x07))) | Select);
}
...
void I2C_SetClockDivider(I2C_Struct* I2Cx, uint8_t Select)
{
    I2Cx->CLK.B[0] = (I2Cx->CLK.B[0] & (~((uint8_t )0x70))) | (Select & ((uint8_t )0x70));
}
...
void I2C_SetPreDriveTime(I2C_Struct* I2Cx, uint32_t Select)
{
    I2Cx->CR0.B[1] = (I2Cx->CR0.B[1] & (~((uint32_t)0x0000C000))) | (Select & ((uint32_t)0x0000C000));
}
...
void I2C_SetSlaveAddress(I2C_Struct* I2Cx, uint8_t I2C_SADRx, uint8_t Address)
{
    if(I2C_SADRx == ((uint32_t)0x00000002))
        I2Cx->SADR.B[0] = Address;

    if(I2C_SADRx == ((uint32_t)0x00000004))
        I2Cx->SADR.B[1] = Address;
}



#line 404 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_I2C_DRV.c"
...
uint8_t I2C_GetSlaveAddress(I2C_Struct* I2Cx, uint8_t I2C_SADRx)
{
    if(I2C_SADRx == ((uint32_t)0x00000080))
        return 0x00;
...
uint32_t I2C_GetITSource(I2C_Struct* I2Cx)
{
    return (I2Cx->INT.W &(((uint32_t)0x00000004) | ((uint32_t)0x00000008) | ((uint32_t)0x00000002) | ((uint32_t)0x00000010) | 0 | ((uint32_t)0x00000001)));
}
