...
#line 33 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_RTC_MID.c"
...
MID_StatusTypeDef MID_RTC_Init(RTC_HandleTypeDef *mRTC)
{
    ...
    do{ (mRTC)->Instance ->KEY . W &= ~((uint32_t)0x0000FFFF); (mRTC)->Instance ->KEY . W |= 0x0000A217UL; }while(0);
    ...
    {
        if(mRTC->Init.RTC_CK_DIV != ((uint32_t)0x00000030))
        {
            mRTC->Init.RTC_CK_DIV = ((uint32_t)0x00000030);
        }
        
        if(mRTC->Init.RTC_CK_PDIV != ((uint32_t)0x00000000))
        {
            mRTC->Init.RTC_CK_PDIV = ((uint32_t)0x00000000);
        }
        
         
        (mRTC)->Instance ->CLK . W &= ~(((uint32_t)0x00000030)); (mRTC)->Instance ->CLK . W |= (mRTC->Init . RTC_CK_DIV);;
        (mRTC)->Instance ->CLK . W &= ~(((uint32_t)0x00000080)); (mRTC)->Instance ->CLK . W |= (mRTC->Init . RTC_CK_PDIV);;
        (mRTC)->Instance ->CLK . W &= ~(((uint32_t)0x0000000C)); (mRTC)->Instance ->CLK . W |= (mRTC->Init . RTC_CK_SEL);;
        ((mRTC)->Instance ->INT . W = (mRTC->Init . RTC_INT | ((uint32_t)0x00000001)));      
        
         
        MID_RTC_SetTime(mRTC, mRTC->Init.RTC_RLR);
         
        ((mRTC)->Instance ->CR0 . MBIT . EN = 1);
    }
     
    do{ (mRTC)->Instance ->KEY . W = 0x00000000UL; }while(0);
...
MID_StatusTypeDef RTC_EnterInitMode(RTC_HandleTypeDef *mRTC)
{
    ...
    {
        mRTC->Instance->CR0.W = (uint32_t)0xFFFFFFFF;
        
        tickstart = MID_GetTick();
        
        while((mRTC->Instance->CR0.W & 0x000B3333) != 0x000B3333)
        {
            if((MID_GetTick()-tickstart)>1000U)
            {
                 return MID_TIMEOUT;
            }
        }
...
MID_StatusTypeDef MID_RTC_SetTime(RTC_HandleTypeDef *mRTC, uint32_t RTC_RLR)
{
    ...
    (mRTC)->Instance ->CR0 . W &= ~(((uint32_t)0x00000030)); (mRTC)->Instance ->CR0 . W |= (((uint32_t)0x00000020));;
    ((mRTC)->Instance ->CR1 . W = 0x01U);
    while(((((mRTC)->Instance ->STA . W) & (((uint32_t)0x00000020))) == (((uint32_t)0x00000020)))== 0U);
    ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000020)));
     
    (mRTC)->Instance ->CR0 . W &= ~(((uint32_t)0x00000030)); (mRTC)->Instance ->CR0 . W |= (((uint32_t)0x00000030));;
    ((mRTC)->Instance ->CR1 . W = 0x01U);
    ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000020)));
...
MID_StatusTypeDef MID_RTC_GetTime(RTC_HandleTypeDef *mRTC)
{
    ...
    do{ (mRTC)->Instance ->KEY . W &= ~((uint32_t)0x0000FFFF); (mRTC)->Instance ->KEY . W |= 0x0000A217UL; }while(0);
    (mRTC)->Instance ->CR0 . W &= ~(((uint32_t)0x00000030)); (mRTC)->Instance ->CR0 . W |= (((uint32_t)0x00000000));;
    ((mRTC)->Instance ->CR1 . W = 0x01U);
    __nop();__nop();__nop();__nop();__nop();
    ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000020)));
    RTC_CNT0 = ((RTC_Struct*) ((uint32_t)0x5D040000))->CAP.W;
    
    ((mRTC)->Instance ->CR1 . W = 0x01U);
    __nop();__nop();__nop();__nop();__nop();
    ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000020)));
    RTC_CNT1 = ((RTC_Struct*) ((uint32_t)0x5D040000))->CAP.W;
    ...
    while(RTC_CNT0!=RTC_CNT1)
    {
        ...
        __nop();__nop();__nop();__nop();__nop();
        ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000020)));
        RTC_CNT0 = ((mRTC)->Instance ->CAP . W );
        
        ((mRTC)->Instance ->CR1 . W = 0x01U);
        __nop();__nop();__nop();__nop();__nop();
        ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000020)));
        RTC_CNT1 = ((mRTC)->Instance ->CAP . W );
    }
...
MID_StatusTypeDef MID_RTC_SetAlarm_IT(RTC_HandleTypeDef *mRTC)
{
    do{ if((mRTC)->Lock == MID_Locked) return MID_BUSY; else (mRTC)->Lock = MID_Locked; }while(0);
    mRTC->State = MID_RTC_STATE_BUSY;
    
    do{ (mRTC)->Instance ->KEY . W &= ~((uint32_t)0x0000FFFF); (mRTC)->Instance ->KEY . W |= 0x0000A217UL; }while(0);
    
     
    ((mRTC)->Instance ->CR0 . MBIT . ALM_EN = 1);
    ((mRTC)->Instance ->INT . W = (((uint32_t)0x00000002) | ((uint32_t)0x00000001)));
    
    do{ (mRTC)->Instance ->KEY . W = 0x00000000UL; }while(0);
    
    mRTC->State = MID_RTC_STATE_READY;
    do{ (mRTC)->Lock = MID_UnLocked; }while(0);
    return MID_OK;
}
...
void MID_RTC_IRQHandler(RTC_HandleTypeDef *mRTC)
{
    ...
    if(((((mRTC)->Instance ->STA . W) & (((uint32_t)0x00000020))) == (((uint32_t)0x00000020))) != 0U)
    {
    ...
    if(((((mRTC)->Instance ->STA . W) & (((uint32_t)0x00000010))) == (((uint32_t)0x00000010))) != 0U)
    {
         
        MID_RTC_TFCallback(mRTC);
        
         
        ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000010)));
    }
     
    if(((((mRTC)->Instance ->STA . W) & (((uint32_t)0x00000008))) == (((uint32_t)0x00000008))) != 0U)
    {
         
        MID_RTC_TSCallback(mRTC);
        
         
        ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000008)));
    }
     
    if(((((mRTC)->Instance ->STA . W) & (((uint32_t)0x00000004))) == (((uint32_t)0x00000004))) != 0U)
    {
          
        MID_RTC_PCCallback(mRTC);
        
         
        ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000004)));
    }
     
    if(((((mRTC)->Instance ->STA . W) & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))) != 0U)
    {
          
        MID_RTC_AlarmCallback(mRTC);
        
         
        ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000002)));
    }
...
MID_StatusTypeDef MID_RTC_DeactivateAlarm(RTC_HandleTypeDef *mRTC)
{
    ...
    ((mRTC)->Instance ->CR0 . MBIT . ALM_EN = 0);
    ((mRTC)->Instance ->INT . W &= ~(((uint32_t)0x00000002) | ((uint32_t)0x00000001)));
    ((mRTC)->Instance ->STA . W = (((uint32_t)0x00000002)));           
    
    while(((((mRTC)->Instance ->STA . W) & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002)))==MID_RTC_STATE_RESET)
    {
        if(MID_GetTick()-starttick>1000U)
        {
...
MID_StatusTypeDef MID_RTC_Capture_Convert(RTC_HandleTypeDef *mRTC, uint32_t RTC_CAP)
{
    ...
    if((mRTC->Init.HourFormat&0x01U)==0x01U)
    {
        if((mRTC->sTime.Hours)>=12U)
        {
            mRTC->sTime.TimeFormat = 0x01U;
