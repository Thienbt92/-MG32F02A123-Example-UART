...
#line 32 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Middleware\\Source\\MG32x02z_IWDT_MID.c"
...
MID_StatusTypeDef MID_IWDT_Init(IWDT_HandleTypeDef *mIWDT)
{
    ...
    ((mIWDT)->Instance ->KEY . W, 0x0000A217U);
    mIWDT->Instance->KEY.W = 0xA217;

     
    ((mIWDT)->Instance ->CR0 . W = 0x00000001U);
    
    ((mIWDT)->Instance ->STA . W = ((((uint32_t)0x00000008)|((uint32_t)0x00000004)|((uint32_t)0x00000002))));
    
     
    mIWDT->Instance->CLK.MBIT.CK_DIV = mIWDT->Init.Prescaler;
    ((mIWDT)->Instance ->KEY . W = 0x00002014U);

     
    ((mIWDT)->Instance ->INT . W = (mIWDT->Init . Interrupt));
    ...
    {
        if((MID_GetTick() - tickstart ) > 39U)
        {
            return MID_TIMEOUT;
        }
    }
    
    ((mIWDT)->Instance ->KEY . W, 0x00000000U);
...
void MID_IWDT_IRQHandler(IWDT_HandleTypeDef *mIWDT)
{
    ...
    if((((mIWDT)->Instance ->INT . W & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002)))!= CLR)
    {
         
        if((((mIWDT)->Instance ->STA . W & (((uint32_t)0x00000008))) == (((uint32_t)0x00000008))) != CLR)
        {
            ((mIWDT)->Instance ->STA . W = (((uint32_t)0x00000008)));
    ...
    if((((mIWDT)->Instance ->INT . W & (((uint32_t)0x00000004))) == (((uint32_t)0x00000004)))!= CLR)
    {
         
        if((((mIWDT)->Instance ->STA . W & (((uint32_t)0x00000004))) == (((uint32_t)0x00000004))) != CLR)
        {
                ((mIWDT)->Instance ->STA . W = (((uint32_t)0x00000004)));
             
            MID_IWDT_EW0INTCallback(mIWDT);
        }
    }
    
    if((((mIWDT)->Instance ->INT . W & (((uint32_t)0x00000008))) == (((uint32_t)0x00000008)))!= CLR)
    {
         
        if((((mIWDT)->Instance ->STA . W & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))) != CLR)
        {
            ((mIWDT)->Instance ->STA . W = (((uint32_t)0x00000002)));
