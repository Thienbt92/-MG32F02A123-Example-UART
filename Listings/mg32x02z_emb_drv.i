...
#line 32 "C:\\Keil_v5\\ARM\\PACK\\Megawin\\CM0_DFP\\2.0.4\\Device\\MG32x02z\\MG32F02A_Driver\\Source\\MG32x02z_EMB_DRV.c"
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.MBIT.EN = EMB_EN;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.MBIT.SYNC_EN = EMB_SYNC_Cmd;
}
...
void EMB_AddressDataBusMode_Config( EMB_AddressDataTypeDef* EMB_AddressDataMode)
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.W = ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.W & (~(((uint32_t)0x00000400) | 
                                 ((uint32_t)0x00003000) | 
                                 ((uint32_t)0x00000800) | 
                                 ((uint32_t)0x01000000) |
                                 0));
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.W = ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.W | (EMB_AddressDataMode->EMB_AddressBit | 
                               EMB_AddressDataMode->EMB_BusMode |
                               EMB_AddressDataMode->EMB_ALE2_EN | 
                               EMB_AddressDataMode->EMB_ALE2Mode |
                               0x00000100);
}
...
void EMB_WriteMode_Select(EMB_WriteMode_TypeDef EMB_WriteMode)
{
    ...
    tmp = (((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.W  & (~(((uint32_t)0x00000002))));
    tmp = tmp | EMB_WriteMode;
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.W = ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.W | tmp;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR2.W = (EMB_TimeState->EMB_ACCH | 
                  EMB_TimeState->EMB_ACCS | 
                  EMB_TimeState->EMB_ACCW | 
                  EMB_TimeState->EMB_ALES | 
                  EMB_TimeState->EMB_ALEH |
                  EMB_TimeState->EMB_ALEW | 
                  0);
}
...
void EMB_IT_Cmd(uint32_t EMB_IT, FunctionalState EMB_IT_State)
{
	...
	{
        ((EMB_Struct*) ((uint32_t)0x4D020000))->INT.W &=  (~EMB_IT);
	}
	else
	{
		((EMB_Struct*) ((uint32_t)0x4D020000))->INT.W |= EMB_IT;
...
{
     ((EMB_Struct*) ((uint32_t)0x4D020000))->INT.MBIT.IEA = EMB_ITEA_State;
}
...
DRV_Return EMB_GetSingleFlagStatus(uint32_t EMB_Flag)
{
    if((((EMB_Struct*) ((uint32_t)0x4D020000))->STA.W & EMB_Flag)!=EMB_Flag)
    {
...
{
    return(((EMB_Struct*) ((uint32_t)0x4D020000))->STA.W);
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->STA.W = EMB_Flag;
...
DRV_Return EMB_SignalSWAP_Cmd(uint32_t EMB_SWAPSignal , FunctionalState EMB_SWAPSignal_Status)
{
    if((EMB_SWAPSignal & (~((uint32_t)0x00000100)))!=0)
    {
        return(DRV_Failure);
    }
    ...
    {
        ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.W |=EMB_SWAPSignal;
    }
    else
    {
        ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.W &= (~EMB_SWAPSignal);
...
DRV_Return EMB_SignalInverse_Cmd(uint32_t EMD_InverseSignal , FunctionalState EMB_InverseSignal_Status)
{
    if((EMD_InverseSignal & (~((uint32_t)0x00000008)|((uint32_t)0x00000004)|((uint32_t)0x00000002)|((uint32_t)0x00000001)))!=0)
    {
        return(DRV_Failure);
    }    
    ...
    {
        ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.W |= EMD_InverseSignal;
    }
    else
    {
        ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.W &= (~EMD_InverseSignal);
...
DRV_Return EMB_SignalSW_Cmd(uint32_t EMB_SWSignal ,FunctionalState EMB_SignalSW_Status)
{
    if((EMB_SWSignal & (~((uint32_t)0x01000000) | ((uint32_t)0x00400000) | ((uint32_t)0x00100000) | ((uint32_t)0x00040000) | ((uint32_t)0x00010000)))!=0)
    {
        return(DRV_Failure);
    }
    if(EMB_SignalSW_Status==ENABLE)
    {
        ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.W |= EMB_SWSignal;
    }
    else
    {
        ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.W &= (~EMB_SWSignal);
...
DRV_Return EMB_SendSignalStatus_SW(uint32_t EMB_SWSignal ,BitAction EMB_SWSingal_Status)
{
    if((EMB_SWSignal & (~((uint32_t)0x02000000) | ((uint32_t)0x00800000) | ((uint32_t)0x00200000) | ((uint32_t)0x00080000) | ((uint32_t)0x00020000)))!=0)
    {
        return(DRV_Failure);
    }

    if(EMB_SWSingal_Status==ENABLE)
    {
        ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.W |= EMB_SWSignal;
    }
    else
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.MBIT.WE_MUX = EMB_MWE;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.MBIT.OE_MUX = EMB_MOE;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CLK.MBIT.CK_PSC = EMB_MCLK;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.MBIT.WE_CTL = EMB_WE;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.MBIT.OE_CTL = EMB_OE;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.MBIT.CE_MDS = EMB_CE;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR1.MBIT.MAM1_SEL = EMB_MA1_PIN;
}
...
{
    ((EMB_Struct*) ((uint32_t)0x4D020000))->CR0.MBIT.DMA_EN = EMB_DMAState;
}
